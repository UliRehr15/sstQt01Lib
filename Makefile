...
CXXFLAGS      = -pipe -g -fPIC -std=c++0x -D_REENTRANT -Wall -W $(DEFINES)
...
SOURCES       = sstQt01Tab.cpp \
		...
		sstQt01ShapeType.cpp qrc_tooltips.cpp \
		moc_sstQt01Lib.cpp \
