 ...
 *
 **********************************************************************/
// sstDs2_tstrec2_qt_tab.cpp   16.09.15  Re.    16.09.15  Re.
//
...
//=============================================================================
TstRec2ViewCls::TstRec2ViewCls()
{
    createActions();
    setupContextMenu();
}
//=============================================================================
void TstRec2ViewCls::setupContextMenu()
{
...
//=============================================================================
void TstRec2ViewCls::createActions()
{
...
//=============================================================================
void TstRec2ViewCls::actionRowsDelete()
{
...
//=============================================================================
void TstRec2ViewCls::actionRowsInsert()
{
  const QModelIndex index = this->selectionModel()->currentIndex();
