...
//    if (oElement.type == 0)
    ...
    // shapeItems.append(oShapeItemCsv);
  }
...
//=============================================================================
//int sstQt01PathStoreViewCls::ReadRecPos (int iKey, dREC04RECNUMTYP dRecNo, void* vRecAdr) const
//{
//  int iStat = 0;
//  //-----------------------------------------------------------------------------
//  if ( iKey != 0) return -1;
...
//}
//=============================================================================
//int sstQt01PathStoreViewCls::WriteRecPos (int iKey, dREC04RECNUMTYP dRecNo, void* vRecAdr)
//{
//  int iStat = 0;
//  //-----------------------------------------------------------------------------
//  if ( iKey != 0) return -1;
...
//}
//=============================================================================
//int sstQt01PathStoreViewCls::DeleteRecPos (int iKey, dREC04RECNUMTYP dRecNo)
//{
//  int iStat = 0;
//  //-----------------------------------------------------------------------------
//  if ( iKey != 0) return -1;
...
//}
//=============================================================================
//int sstQt01PathStoreViewCls::WriteNew (int iKey, dREC04RECNUMTYP *dRecNo, void* vRecAdr)
//{
//  int iStat = 0;
//  //-----------------------------------------------------------------------------
//  if ( iKey != 0) return -1;
...
QString sstQt01PathStoreViewCls::getToolTip(dREC04RECNUMTYP index)
{
  ...
  int iStat = 0;
  oShapeItem = this->shapeItems.at(index);
...
int sstQt01PathStoreViewCls::setToolTip(dREC04RECNUMTYP index, std::string oTooltip)
{
  ...
  sstQt01ShapeItem oShapeItem;
  // QString oQStr;
  // oQStr = QString::fromStdString(oTooltip);
  // iStat = this->poShapeItemMainTable->Read(0,index,&oMainRec);
  oShapeItem = this->shapeItems.at( index);
...
sstQt01ShapeItem sstQt01PathStoreViewCls::getShapeItem(dREC04RECNUMTYP index)
{
  ...
  oItem = this->shapeItems.at( index);
...
int sstQt01PathStoreViewCls::getShapeItem2(int iKey, dREC04RECNUMTYP index,sstQt01ShapeItem *poShapeItem)
{
  ...
  sstQt01ShapeItem oItem;
  *poShapeItem = this->shapeItems.at( index);
...
//=============================================================================
int sstQt01PathStoreViewCls::countItems()
{
  // dREC04RECNUMTYP dRecs = this->poShapeItemMainTable->count();
  dREC04RECNUMTYP dRecs = 0;
  return (int) dRecs;
}
//=============================================================================
